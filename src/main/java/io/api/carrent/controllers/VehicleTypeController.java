...
public class VehicleTypeController {
    ...
    @SecurityRequirement(name = SECURITY_BEARER)
    @Operation(description = "Cadastra um novo tipo de veículo. Obrigatorio")
    ...
    @PreAuthorize(ROLE_ADMIN)
    @SecurityRequirement(name = SECURITY_BEARER)
    @Operation(description = "Atualiza um tipo de veículo existente")
    ...
    @PreAuthorize(ROLE_ADMIN)
    @SecurityRequirement(name = SECURITY_BEARER)
    @Operation(description = "Excluí um tipo de veículo existente se não estiver associado a veículos.")
